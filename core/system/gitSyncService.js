...
const BLOCKED_PATTERNS = [
  ...
  /(^|\/)\.tmp\//i,
  /(^|\/)scratch\//i,
  /(^|\/)(playwright\/)?tests\/(scratch|temp|draft|drafts|ai)\//i,
  /(^|\/)(playwright\/)?tests\/.*(draft_|temp_|scratch_|ai_|ai-)[^/]*\.(js|ts)$/i,
  /(^|\/)(playwright\/)?tests\/.*[-_]ai\.(spec|test)\.(js|ts)$/i,
  /\.(scratch|draft|tmp)\.(js|ts)$/i,
  /\.ai\.(spec|test)\.(js|ts)$/i,
  /(^|\/).*ai[-_]test.*\.(js|ts)$/i,
  /(^|\/)(temp_|draft_)[\w-]+\.(js|ts)$/i,
  /(^|\/)test_rec\.js$/i,
  /(^|\/)test_output.*\.txt$/i,
  /(^|\/).*_output\.txt$/i,
  /(^|\/)test-output\.txt$/i,
  /(^|\/)data\/(scratch|temp_|test_)/i,
  /(^|\/)\.ai\//i,
  /(^|\/)ai\/(personal|candidates|drafts|tests)\//i,
  /\.log$/i,
  /Thumbs\.db$/i,
  /\.DS_Store$/i,
  /(^|\/)\.master_process/i,
